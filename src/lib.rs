...
const FINGERPRINT_EMOJIS: [(&str, &str); 350] = [
// 0–63: Matrix SAS set
("🐶", "Dog"),        ("🐱", "Cat"),        ("🦁", "Lion"),
("🐎", "Horse"),      ("🦄", "Unicorn"),    ("🐷", "Pig"),
...
// Additions
("0️⃣", "Zero"),      ("1️⃣", "One"),       ("2️⃣", "Two"),
("3️⃣", "Three"),     ("4️⃣", "Four"),      ("5️⃣", "Five"),
("6️⃣", "Six"),       ("7️⃣", "Seven"),     ("8️⃣", "Eight"),
("9️⃣", "Nine"),      ("♻️", "Recycle"),    ("⚡", "Lightning"),
("💎", "Diamond"),    ("🌈", "Rainbow"),    ("❄️", "Snowflake"),
("🌊", "Wave"),       ("🎲", "Dice"),       ("🧲", "Magnet"),
("🪐", "Saturn"),     ("🌋", "Volcano"),    ("⭐", "Star"),
("🐬", "Dolphin"),    ("🦊", "Fox"),        ("🦉", "Owl"),
("🏔️", "Mountain"),   ("🧊", "Ice"),        ("🎯", "Target"),
("🛡️", "Shield"),     ("⚙️", "Gear"),       ("🔱", "Trident"),

("🦀", "Crab"),       ("🦈", "Shark"),      ("🐸", "Frog"),
("🦩", "Flamingo"),   ("🦜", "Parrot"),     ("🐍", "Snake"),
("🦞", "Lobster"),    ("🐪", "Camel"),      ("🦒", "Giraffe"),
("🐊", "Crocodile"),  ("🍉", "Watermelon"),
...
("🪴", "Plant"),      ("🌻", "Sunflower"),  ("🌴", "Palm"),
("🍂", "Leaf"),       ("🐚", "Shell"),      ("🦎", "Lizard"),
("🦭", "Seal"),       ("🦔", "Hedgehog"),   ("🦚", "Peacock"),
("🐞", "Ladybug"),    ("🕷️", "Spider"),
...
("🪵", "Log"),        ("🛞", "Wheel"),      ("🪜", "Ladder"),
("🧯", "Extinguisher"),
("🎓", "Graduation"), ("💍", "Ring"),       ("🩺", "Stethoscope"),
("🪃", "Boomerang"),  ("🏺", "Amphora"),    ("🗿", "Moai"),
("🗽", "Liberty"),    ("⛩️", "Shrine"),     ("🕌", "Mosque"),
("🎡", "Ferris Wheel"), ("🎢", "Roller Coaster"), ("🚢", "Ship"),
("🛰️", "Satellite"), ("🌠", "Shooting Star"), ("🌀", "Cyclone"),
("🔮", "Crystal Ball"), ("🪩", "Mirror Ball"), ("🎵", "Music"),
("🕹️", "Joystick"),  ("🖨️", "Printer"),   ("💾", "Floppy"),
("🔋", "Battery"),    ("📡", "Dish"),       ("🏋️", "Weightlifter"),
("🤿", "Diving"),     ("🛹", "Skateboard"),
...
("🫐", "Blueberry"),  ("🥦", "Broccoli"),   ("🌰", "Chestnut"),
("🥜", "Peanut"),     ("🍯", "Honey"),      ("🧂", "Salt"),
("🫖", "Teapot"),     ("🍵", "Tea"),        ("🧃", "Juice Box"),
("🪘", "Long Drum"),  ("🎷", "Saxophone"),  ("🎹", "Piano"),
("🪗", "Accordion"),  ("🏗️", "Crane"),     ("🗼", "Tower"),
("⛲", "Fountain"),   ("🎠", "Carousel"),   ("🛥️", "Speedboat"),
("🚜", "Tractor"),    ("🚒", "Fire Engine"), ("🚑", "Ambulance"),
("🛴", "Scooter"),    ("🪂", "Parachute"),  ("🏄", "Surfer"),
("⛷️", "Skier"),     ("🏊", "Swimmer"),    ("🛷", "Sled"),
("🧨", "Firecracker"), ("🎃", "Pumpkin"), 
...
("🪈", "Flute"),      ("📯", "Horn"),
("🎙️", "Studio Mic"), ("📻", "Radio"),     ("📺", "Television"),
("🖥️", "Desktop"),   ("💿", "CD"),         ("🔦", "Flashlight"),
("🪫", "Low Battery"), ("🧰", "Toolbox"),   ("🪚", "Saw"),
("🔩", "Nut & Bolt"), ("🧱", "Brick"),      ("⛓️", "Chain"),
("🪣", "Bucket"),     ("🪦", "Headstone"),  ("🔗", "Link"),

("🪟", "Window"),     ("🚪", "Door"),       ("🛏️", "Bed"),
("🪑", "Chair"),      ("🚿", "Shower"),     ("🧴", "Lotion"),
("🧽", "Sponge"),     ("🕶️", "Sunglasses"), ("🥾", "Boot"),
("👒", "Sun Hat"),    ("🧤", "Gloves"),     ("🧣", "Scarf"),
("👔", "Necktie"),    ("👗", "Dress"),      ("🩰", "Ballet"),
("🪭", "Fan"),        ("💄", "Lipstick"),   ("💈", "Barber Pole"),
("🔍", "Magnifier"),  ("📿", "Prayer Beads"),
("🪬", "Hamsa"),      ("♟️", "Chess Pawn"), ("🀄", "Mahjong"),
("🃏", "Joker"),      ("🖼️", "Frame"),     ("🪆", "Nesting Doll"),
("🏷️", "Label"),     ("📮", "Postbox"),    ("🗑️", "Wastebasket"),

("🚩", "Red Flag"),   ("🏴‍☠️", "Pirate Flag"),
("🪧", "Placard"),    ("📬", "Mailbox"),
("🪙", "Coin"),       ("💳", "Credit Card"), ("📐", "Triangle Ruler"),
("🗓️", "Calendar"),  ("📊", "Bar Chart"),  ("🔖", "Bookmark"),
("🏵️", "Rosette"),   ("🎗️", "Reminder Ribbon"), ("🪢", "Knot"),
("🩻", "X-Ray"),      ("🪪", "ID Card"),    ("🛗", "Elevator"),
("🚦", "Traffic Light"), ("⛽", "Fuel Pump"), ("🚧", "Construction"),
("🛟", "Ring Buoy"),  ("🪔", "Diya Lamp"),  ("🎑", "Moon Viewing"),
("🧧", "Red Envelope"), ("🎍", "Bamboo"),   ("🪷", "Lotus"),
("🍁", "Maple Leaf"), ("☘️", "Shamrock"),   ("🦠", "Microbe"),
("🪺", "Nest"),       ("🧮", "Abacus"),     ("📣", "Megaphone"),
("🏅", "Medal"),      ("⛺", "Tent"), ("🫧", "Soap Bubble"),
("🏳️‍🌈", "Pride Flag"),   ("🏳️‍⚧️", "Transgender Flag"),
("🏴", "Black Flag"),  ("🇯🇵", "Japan"),
("🇧🇷", "Brazil"),     ("🇨🇦", "Canada"),
("☀️", "Sun"),        ("🌕", "Full Moon"),
("🔰", "Beginner"),   ("♾️", "Infinity"),
...
fn signature_key_to_emoji_fingerprint(sig_key: &[u8]) -> Vec<serde_json::Value> {
    use sha2::{Sha256, Digest};
    let hash = Sha256::digest(sig_key);
    // 5 indices, each from a 2-byte (u16) value mod 350
    (0..5).map(|i| {
        let hi = hash[i * 2] as usize;
        let lo = hash[i * 2 + 1] as usize;
        let idx = ((hi << 8) | lo) % 350;
        let (emoji, desc) = FINGERPRINT_EMOJIS[idx];
        serde_json::json!({ "emoji": emoji, "description": desc })
    }).collect()
}
...
async fn get_group_fingerprints(
    ...
    for member in group.members() {
        ...
        let fingerprint = signature_key_to_emoji_fingerprint(member.signature_key.as_slice());
